...
const Comics = () => {
	...
	return isLoading ? (
		<div className="flex h-[85vh] w-screen justify-center items-center text-white text-4xl">Loading ...</div>
	) : (
		<div>
			<img
			...
			<section className="m-auto w-5/6">
				<div className="flex justify-center items-center">
					<h1 className="flex justify-center  h-12 items-center font-bold text-black border border-solid rounded bg-white shadow-white shadow-xl my-6">
						<label
							htmlFor="searchComic"
							className="flex justify-center  h-12 items-center font-bold px-2 "
						>
							COMICS
						</label>
						<input
